...
**待实现**: 191个端点
- customer 模块剩余 (15个端点 - 重复检测、合并、咨询记录等高级功能)
- recording 模块剩余 (54个端点 - 医疗录音看板、分析等高级功能)
- badge 模块剩余 (21个端点 - 设备检测、厂商池同步等高级功能)
- content 模块剩余 (68个端点 - 内容管理、发布任务、内容种子、提示词模板等)
- support 模块剩余 (12个端点 - 数据浏览器、就诊管理)
- organization 模块剩余 (21个端点 - 医生管理、患者管理等)
