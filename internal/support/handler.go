...
func (h *Handler) RegisterRoutes(mux *http.ServeMux, jwtSecret string) {
	...
	routes := []router.Route{
		...
		{Method: "POST", Path: "/api/v1/inst/system-logs", Handler: h.CreateInstitutionSystemActionLog, Auth: true, AllowedUserTypes: []string{"employee", "mobile"}},
		{Method: "GET", Path: "/api/v1/ops/system-logs", Handler: h.ListSystemActionLogs, Auth: true, AllowedUserTypes: []string{"admin"}},
		{Method: "GET", Path: "/api/v1/ops/system-logs/{id}", Handler: h.GetSystemActionLogByID, Auth: true, AllowedUserTypes: []string{"admin"}},
