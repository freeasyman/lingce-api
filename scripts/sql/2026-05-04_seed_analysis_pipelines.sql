...
VALUES
  ('doctor', 'v1', '医生录音分析 v1', 'post_call_analysis', 'published', 'default doctor pipeline', TRUE, NOW(), NOW()),
  ...
  ('consultant', 'v1', '咨询录音分析 v1', 'admission_consult', 'published', 'default consultant pipeline', TRUE, NOW(), NOW()),
